...
class DeliveryPartnerNotificationPage extends StatefulWidget {
  const DeliveryPartnerNotificationPage({Key? key}) : super(key: key);

  @override
  _DeliveryPartnerNotificationPageState createState() =>
      _DeliveryPartnerNotificationPageState();
}

class _DeliveryPartnerNotificationPageState
    extends State<DeliveryPartnerNotificationPage> {
