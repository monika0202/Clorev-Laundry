...
class ServiceProviderRatingAndReviews extends StatefulWidget {
  const ServiceProviderRatingAndReviews({Key? key}) : super(key: key);

  @override
  _ServiceProviderRatingAndReviewsState createState() =>
      _ServiceProviderRatingAndReviewsState();
}

class _ServiceProviderRatingAndReviewsState
    extends State<ServiceProviderRatingAndReviews> {
  List<Review> _review = [
    Review(
        name: "Sudhir Mishra",
        CRLNo: "CRL-009 (DEL)",
