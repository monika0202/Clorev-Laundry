...
class ServiceProviderBankDetails extends StatefulWidget {
  const ServiceProviderBankDetails({Key? key}) : super(key: key);

  @override
  _ServiceProviderBankDetailsState createState() =>
      _ServiceProviderBankDetailsState();
}

class _ServiceProviderBankDetailsState
    extends State<ServiceProviderBankDetails> {
