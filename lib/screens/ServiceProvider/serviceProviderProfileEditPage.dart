...
class ServiceProviderProfileEditPage extends StatefulWidget {
  const ServiceProviderProfileEditPage({Key? key}) : super(key: key);

  @override
  _ServiceProviderProfileEditPageState createState() =>
      _ServiceProviderProfileEditPageState();
}

class _ServiceProviderProfileEditPageState
    extends State<ServiceProviderProfileEditPage> {
  ...
  late final firstLastNames;
  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    firstLastNames = user.name.split(' ');
  }
                    ...
                    children: [
                      ...
                      Container(
                          ...
                          child: CustomTextField(
                            ...
                            labelText: 'Address (Prefer Store Address)',
