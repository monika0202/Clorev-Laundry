...
class CustomDeliveryPartnerClosedBookings extends StatelessWidget {
  String bookingID;
  String time;
  List<ListItems> listItems;
  CustomDeliveryPartnerClosedBookings({
    Key? key,
                ...
                itemBuilder: ((context, index) {
                  return Container(
                      ...
                      child: Row(
                          ...
                          children: [
                            CategoryType(type: listItems[index].type),
                            Container(
                                child: Row(
                              children: [
                                Container(
...
class CategoryType extends StatelessWidget {
  ...
  const CategoryType({Key? key, required this.type}) : super(key: key);
